...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:scale-95 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-accent text-accent-foreground transition-transform hover:scale-105 hover:shadow-lg",
        destructive:
        ...
        outline:
          "border-2 border-ring bg-secondary text-foreground transition-all duration-300 ease-in-out hover:border-secondary hover:bg-foreground hover:text-secondary hover:shadow-[0_0_20px_#66B2FF]",
        secondary:
