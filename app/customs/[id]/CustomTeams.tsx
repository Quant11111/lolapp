...
const CustomTeams = ({ custom }: CustomTeamsProps) => {
  if (!custom) {
      ...
      <div className="flex size-full flex-col items-center justify-center gap-4 p-2">
        <div className="flex w-full gap-4">
          <div className="flex w-1/2 flex-col gap-1">
            <div className="flex h-12 w-full items-center justify-center rounded border border-secondary-foreground">
              Blue Team
            </div>
          </div>
          <div className="flex w-1/2 flex-col gap-1">
            <div className="flex h-12 w-full items-center justify-center rounded border border-destructive">
              Red Team
            </div>
          </div>
        </div>
